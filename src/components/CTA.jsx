    ...
    <div className="mt-24 p-10 relative overflow-hidden bg-[#f7f7f7]">
      ...
      <div className="relative z-10 max-w-3xl mx-auto text-center">
        ...
        <div className="flex flex-col sm:flex-row justify-center gap-4">
          ...
          <button onClick={handleWhatsAppClick} className="px-8 py-4 bg-transparent border-2 border-black text-black rounded-lg hover:shadow-xl transform hover:-translate-y-1 duration-300 flex items-center justify-center">
